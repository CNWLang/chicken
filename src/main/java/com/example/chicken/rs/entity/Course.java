...
public class Course {
    ...
    public Course(int course_id, String course_no, String start_date, String end_date, int course_state, double course_money, String course_student_name, String course_student_usertel, String course_teacher) {
